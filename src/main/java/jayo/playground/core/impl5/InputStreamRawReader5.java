...
public final class InputStreamRawReader5 implements RawReader {
    ...
    public long readAtMostTo(final @NonNull Buffer destination, final long byteCount) {
        ...
        final var dst = (RealBuffer5) destination;
