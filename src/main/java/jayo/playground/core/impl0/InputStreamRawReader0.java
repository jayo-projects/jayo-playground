...
public final class InputStreamRawReader0 implements RawReader {
    ...
    public long readAtMostTo(final @NonNull Buffer destination, final long byteCount) {
        ...
        if (!(destination instanceof RealBuffer0 _writer)) {
