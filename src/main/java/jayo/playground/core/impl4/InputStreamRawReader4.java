...
public final class InputStreamRawReader4 implements RawReader {
    ...
    public long readAtMostTo(final @NonNull Buffer destination, final long byteCount) {
        ...
        final var dst = (RealBuffer4) destination;
