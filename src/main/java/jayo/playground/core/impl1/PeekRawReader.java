...
import static jayo.playground.core.impl1.Utils.getBufferFromReader;
...
final class PeekRawReader implements RawReader {
    ...
    private final @NonNull RealBuffer1 buffer;
    ...
    public PeekRawReader(final @NonNull Reader upstream) {
        ...
        buffer = (RealBuffer1) getBufferFromReader(upstream);
