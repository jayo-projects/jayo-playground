...
public final class InputStreamRawReader2 implements RawReader {
    ...
    public long readAtMostTo(final @NonNull Buffer destination, final long byteCount) {
        ...
        if (!(destination instanceof RealBuffer2 _writer)) {
